...
client.login(mainSettings.EVENTS).catch(err => console.log("Token bozulmuş lütfen yeni bir token girmeyi dene"));
...
if (sayi2 === 100) {
	kod = makeid(9)
	let fotolar = [
	"https://cdn.discordapp.com/attachments/852824522184065035/973242134977212476/meriherlia-kazan.png",
	]
...
image.save()
const attachment = new MessageAttachment(image.toBuffer(), 'meriaz-oyun.png');
