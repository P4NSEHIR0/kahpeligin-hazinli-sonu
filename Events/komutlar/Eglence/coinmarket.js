...
════════════════════════════════
\`\`\`ID  ÜRÜN                         FİYAT\`\`\`
\`1\` ${client.emojis.cache.find(x => x.name === "meri_stat")} **\`Spotify Hesap\`**\`------------------ 3.000\` ${client.emojis.cache.find(x => x.name === "meri_coin")}
\`2\` ${client.emojis.cache.find(x => x.name === "meri_stat")} **\`Exxen Hesap\`**\`-------------------- 3.200\` ${client.emojis.cache.find(x => x.name === "meri_coin")}
\`3\` ${client.emojis.cache.find(x => x.name === "meri_stat")} **\`Netflix Hesap\`**\`------------------ 4.500\` ${client.emojis.cache.find(x => x.name === "meri_coin")}
\`4\` ${client.emojis.cache.find(x => x.name === "meri_stat")} **\`BluTV Hesap\`**\`-------------------- 6.500\` ${client.emojis.cache.find(x => x.name === "meri_coin")}
\`5\` ${client.emojis.cache.find(x => x.name === "meri_stat")} **\`1.000 Mesaj\`**\`-------------------- 7.000\` ${client.emojis.cache.find(x => x.name === "meri_coin")}
\`6\` ${client.emojis.cache.find(x => x.name === "meri_stat")} **\`10 saat Public Ses\`**\`------------ 20.000\` ${client.emojis.cache.find(x => x.name === "meri_coin")}
\`7\` ${client.emojis.cache.find(x => x.name === "meri_stat")} **\`Classic Nitro\`**\`----------------- 38.000\` ${client.emojis.cache.find(x => x.name === "meri_coin")}
\`8\` ${client.emojis.cache.find(x => x.name === "meri_stat")} **\`Boost Nitro\`**\`------------------- 66.000\` ${client.emojis.cache.find(x => x.name === "meri_coin")}
