...
module.exports.run = async (client, message, args, durum, kanal) => {
        ...
        if (await client.permAyar(message.author.id, message.guild.id, "global") || durum) {
                ...
                let embed = new MessageEmbed()
                        ...
                        .setDescription(`
\`${client.ayarlar.prefix[0]}merikur\`                        
...
.addField("Eglence Komutlar", `\`${client.ayarlar.prefix[0]}bozdur\`
\`${client.ayarlar.prefix[0]}cf\`
\`${client.ayarlar.prefix[0]}coin\`
\`${client.ayarlar.prefix[0]}coinmarket\`
\`${client.ayarlar.prefix[0]}duello @etiket / [userID]\`
\`${client.ayarlar.prefix[0]}daily\`
\`${client.ayarlar.prefix[0]}para\`
\`${client.ayarlar.prefix[0]}paragonder @etiket / [userID]\`
\`${client.ayarlar.prefix[0]}zar\``)
